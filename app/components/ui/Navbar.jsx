...
export default function Navbar() {
  ...
  const links = (
    <>
      <Link className="block px-3 py-2 text-gray-500 font-bold text-sm hover:text-blue-600" href="/">
        Home
      </Link>
      <Link className="block px-3 py-2 text-gray-500 font-bold text-sm hover:text-blue-600" href="/aboutus">
        About Us
      </Link>
      <Link className="block px-3 py-2 text-gray-500 font-bold text-sm hover:text-blue-600" href="/arts">
        Arts
      </Link>
      <Link className="block px-3 py-2 text-gray-500 font-bold text-sm hover:text-blue-600" href="/blogs">
        Blogs
      </Link>
      <Link className="block px-3 py-2 text-gray-500 font-bold text-sm hover:text-blue-600" href="/addarts">
        Add Arts
      </Link>
      <Link className="block px-3 py-2 text-gray-500 font-bold text-sm hover:text-blue-600" href="/managearts">
        Manage Arts
      </Link>
    </>
  );
  ...
  return (
    <nav className="w-full sticky top-0 z-50 bg-base-200/80 shadow-sm">
      ...
      {menuOpen && (
        <div className="lg:hidden px-4 pt-3 pb-4 border-t border-gray-200 bg-base-200/95">
